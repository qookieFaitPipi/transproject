    ...
    <div className={styles.feedbackForm} id='feedBackForm'>
      <div className={styles.feedbackFormContent}>
        ...
        <div className={styles.feedbackCheckBoxBlock}>
          ...
          <div className={styles.feedbackCheckBoxText}>Предоставляя свои персональные данные даю согласие на обработку, хранение и использование своих персональных данных на основании ФЗ № 152-ФЗ «О персональных данных» от 27.07.2006 г. в целях содействия мне в трудоустройстве и не возражаю против передачи моих персональных для ознакомления и проверки специалистам и руководителям компании, принимающим участие в процессе подбора персонала. С <a href={fl5}>Политикой обработки персональныз данных</a> в ООО «ТранспроектИнжиниринг» ознакомлен.</div>
        </div>
