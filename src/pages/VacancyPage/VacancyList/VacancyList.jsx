          ...
          <div className={styles.vacancyInfo}>
            ...
            <div className={styles.vacancyText}>
              <ul> <b>Обязанности:</b><br />
                ...
                <li>— Контроль подготовки запросов и получения ответов от уполномоченных органов исполнительной власти и специализированных организаций о существующих ограничениях намечаемой хозяйственной деятельности по объекту проектирования (ООПТ, ЗСО, полезные ископаемые и пр.);</li>
