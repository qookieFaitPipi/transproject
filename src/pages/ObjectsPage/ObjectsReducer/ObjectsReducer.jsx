...
const ObjectsReducer = () => {
  const objects = [
    ...
    { 
      ...
      text: 'одготовка документации по планировке территории для размещения линейного объекта: «Школьная ул.» для нужд Санкт-Петербурга.',
    },
    { 
      id: 33, 
      title: 'ДПТ «ул. Юты Бондаровской от Парковой ул. до Ропшинского шоссе»', 
      text: 'одготовка документации по планировке территории для размещения линейного объекта: «ул. Юты Бондаровской от Парковой ул. до Ропшинского шоссе» для нужд Санкт-Петербурга.',
    },
  ];
