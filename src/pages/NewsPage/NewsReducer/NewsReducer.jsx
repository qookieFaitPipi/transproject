  ...
  const news = [
    {
      ...
      date: '1.05.2023', 
      title: '',
      text: 'Уважаемые коллеги, друзья и соотечественники, поздравляем с праздником весны и труда! Желаем вам, чтобы каждый год был продуктивнее предыдущего, чтобы все ваши труды не были напрасны и радовали результатами! Счастливых праздничных дней и отличного настроения!',
      size: 1,
    },
    {
      id: 8,
